      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-500 via-red-400 to-yellow-300">
        ...
        <div className="bg-white py-16">
          <div className="container mx-auto px-4">
            <Typography
              variant="h3"
              className="text-gray-800 text-center font-bold text-3xl mb-12 relative"
            >
              Zero Hassle
        ...
        <div className="relative w-full overflow-hidden p-20">
          ...
          >
            ...
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
              Seamless, secure, and stress-free healthcare claims at your
              fingertips.{" "}
            </div>
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
              "More transparency, less friction—your claims, your control."
            </div>
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
              "Your health, your records, your peace of mind—simplified claims
              processing."
            </div>
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
              "AI-powered claims processing—faster approvals, zero hassle."
            </div>
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
              "Medical claims, made effortless. Focus on your health, we’ll
              handle the rest."
            </div>
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
              "Transforming healthcare claims—instant, accurate, and secure."
            </div>
            <div className="w-72 h-72 bg-red-400 rounded-full flex-shrink-0 flex items-center justify-center text-white text-2xl shadow-lg shadow-pink-500/50 p-2 font-semibold italic text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="p-20 gap-20">
            <div>
              <Accordion
                open={open === 1}
                className="mb-2 rounded-lg border border-pink-500 px-4 cursor-pointer"
              >
                <AccordionHeader
                ...
                <AccordionBody className="pt-0 text-base font-normal">
                  You can submit a claim through our platform by providing your
                  name, email, claim amount, and a description of the claim. You
                  can also upload supporting documents like medical bills or
                  prescriptions.
                </AccordionBody>
              </Accordion>
            </div>
            ...
            <div>
              ...
              >
                ...
                <AccordionBody className="pt-0 text-base font-normal">
                  Once you submit a claim, you can track its status (Pending,
                  Approved, or Rejected) in your dashboard. You will also
            ...
            <div>
              <Accordion
                open={open === 3}
                className="rounded-lg border border-pink-500 px-4 "
              >
                <AccordionHeader
                ...
                <AccordionBody className="pt-0 text-base font-normal">
                  The insurer will review your claim and determine the approved
                  amount based on your policy coverage. This will be reflected
                  in your dashboard once reviewed.
                </AccordionBody>
              </Accordion>
            </div>
          </div>
